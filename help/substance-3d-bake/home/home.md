...
Les <b>Substance Bakers</b> sont un ensemble d&#39;outils d&#39;algorithme avancé permettant de calculer des informations basées sur le maillage dans des fichiers de texture. Ils peuvent être utilisés par tout artiste disposant d’un Maillage 3D pour tirer parti de méthodes de texturation avancées. Le bake est un processus au cœur du workflow du logiciel de Substance de données afin d&#39;offrir<b> de puissants outils</b> et <b>la texturation automatisée</b>.

Cette documentation couvre les <b>fondamentaux du bake</b> et les <b>problèmes courants</b>, ainsi que les erreurs pouvant être rencontrées lors de l&#39;utilisation de ce processus.
...
* [Qu’est-ce qui Bake ?](../getting-started/what-is-baking/what-is-baking.md)
* Bake avec :
...
* [Le dithering est-il appliqué aux textures bake ?](../common-questions/dithering-applied-baked/is-dithering-applied-to-baked-textures.md)
...
* [La sortie de Baker est entièrement noire ou vide](https://helpx.adobe.com/substance-3d/unlisted/documentation/bake/baker-output-is-fully-black-159451835.html)

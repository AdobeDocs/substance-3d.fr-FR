...
L&#39;Ambient occlusion du baker de maillage permet de bake une texture d&#39;Ambient occlusion à partir de maillages de poly élevé. Il est plus lent que le baker de base [ambient occlusion](../../bakers-settings/ambient-occlusion/ambient-occlusion.md), mais produit des résultats plus précis.
...
| **Carte des normales** | Tracé facultatif d’une texture normale. Peut être utilisé pour remplacer le calcul intérieur du baker. |
| **Espace universel** | Si cette option est activée, la texture normale est interprétée comme une Normale de l&#39;espace monde et non comme un Repère tangent. |
...
| **Plan Sol** | Si cette option est activée, simulez un plan sous le cadre de sélection du maillage sur l’axe XZ pour entrer en collision avec des rayons secondaires. Cela simule une ombre provenant d&#39;un plan d&#39;étage invisible. |
| **Décalage du plan du Sol** | Permet d’éloigner le plan du maillage pour réduire l’intensité de l’effet. La valeur est absolue et non relative à la taille du maillage. |

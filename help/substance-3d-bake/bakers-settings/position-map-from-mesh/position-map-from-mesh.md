...
breadcrumb-title: ''
description: Calculer des cartes de position précises à partir de maillages à polygone élevé pour capturer des informations d'emplacement de géométrie précises.
helpx_creative_field: ""
helpx_description: bakers > Bakers Settings > Position map from Mesh
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Map position depuis un maillage
...
# Map position depuis un maillage

La texture Position du baker maillage calcule l&#39;emplacement de la géométrie de maillage en polygone et l&#39;enregistre dans une texture. Il est similaire au baker de position de base, mais peut produire des résultats plus précis.

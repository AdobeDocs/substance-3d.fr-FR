...
* Windows 10 « Fall Creator » / Mise à jour d’octobre (version 1809) ou ultérieure installée\*\*

</td>
<td style="border: 0;" valign="top">

![comparaison des GPU raytracings activés/désactivés](../../assets/rtx-ao-demo.gif "comparaison des GPU raytracings activés/désactivés"){zoomable="yes"}

</td>
</tr>
</table>

\* : les GPU NVIDIA compatibles incluent tous les GPU utilisant l’architecture Pascal ou plus récents. C’est-à-dire les séries GTX 10, Titan V, RTX 20 ou plus récentes.

\*\* : pour vérifier votre version de Windows, cliquez sur le menu Démarrer, saisissez &#39;winver&#39; et appuyez sur Entrée.\
Vous pouvez obtenir la mise à jour via la [page dédiée](https://support.microsoft.com/en-us/help/4028685/windows-10-get-the-update) sur le site Web de support Microsoft.
...
| Baker | Prend en charge les GPU raytracings |
| --- | --- |
| Masque d’opacité du filet | <div><img alt="(erreur)&quot; data-preserve-html=&quot;true" src="../../assets/error.svg"/></div> \* |
...
| Texture transférée du filet | <div><img alt="(erreur)&quot; data-preserve-html=&quot;true" src="../../assets/error.svg"/></div> \* |
| Sens de l’espace universel | <div><img alt="(erreur)&quot; data-preserve-html=&quot;true" src="../../assets/error.svg"/></div> |
| Normales spatiales mondiales | <div><img alt="(erreur)&quot; data-preserve-html=&quot;true" src="../../assets/error.svg"/></div> |


\* : prend en charge le lancer de rayons du processeur, qui est nettement plus lent que le GPU raytracing.

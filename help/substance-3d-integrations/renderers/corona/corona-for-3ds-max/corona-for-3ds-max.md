...
À l&#39;aide du plug-in [3ds Max](../../../3d-applications/3ds-max/3ds-max.md), vous pouvez choisir Corona dans le menu Substance pour configurer automatiquement la matière Corona avec les entrées de texture Substance.
...
* **LiftGamaGain** est créé entre la sortie Couleur de base et l&#39;entrée Couleur de base. Une valeur gamma de 0,455 est utilisée pour corriger la différence de couleur.
...
* **CoronaMix** est créé entre la sortie de Couleur de l&#39;éclat et l&#39;entrée de Couleur de l&#39;éclat. Une quantité de mélange de 0 est définie et un multiplicateur de 2 est défini pour le calque de base. Les utilisateurs peuvent régler la valeur Quantité de mélange pour contrôler le reflet.

...
breadcrumb-title: ''
description: Découvrez comment convertir les sorties du matériau de Substance pour qu’elles correspondent à différents workflows et exigences de rendu.
...
Le plug-in de Substance génère des sorties et crée automatiquement des matériaux pour des workflows spécifiques. Toutefois, avec les applications DCC et les systèmes de rendu tiers, vous devrez peut-être convertir manuellement les sorties métallique/brutes. Les intégrations suivantes prennent en charge les workflows de rendu automatique et convertissent correctement tous les types de mappages si nécessaire :
...
Si vous créez une Substance personnalisée, vous pouvez créer les sorties spécifiques dont vous avez besoin pour les systèmes de rendu tels que Vray et Corona. À l’aide du nœud de conversion métallique/rugosité (Bibliothèque > Utilitaires PBR), vous pouvez facilement convertir les mappages de base color, de rugosité et métallique dans le moteur de rendu spécifique.

...
Le plug-in Substance prend en charge les matériaux personnalisés Unreal, Unity et glTF. Avant de charger un fichier sbsar, vous pouvez sélectionner le mode d’ombrage à utiliser.

## Table des matières

## Unity Material

Lorsque vous utilisez le matériau Unity, l’effet de calque Matériau est défini automatiquement. Le module externe de Substance place le matériau Unity directement au-dessus du matériau de l&#39;élément de Substance.
...
| Occlusion ambiante | Linéaire | Unity Ambient Occlusion |

![](../../../assets/unity-1.png){width="600px"}

## Matière irréelle

Lorsque vous utilisez le matériau irréel, l’effet de calque Matériau est défini automatiquement. Le module externe de Substance place le matériau irréel directement au-dessus du matériau de l&#39;élément de Substance.

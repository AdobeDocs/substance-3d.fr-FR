...
* **Sélectionner un Graphe :** permet de choisir le graphe du fichier de Substance à partir duquel créer un matériau.
...
* **Baker sur le disque :** ce paramètre bake les textures générées par la Substance vers un fichier bitmap.
...
* **Générateur aléatoire :** ce paramètre fera varier la génération procédurale de la Substance. Ce paramètre est idéal pour créer une version randomisée de la même Substance. Cela vous permet de faire varier rapidement les paramètres de la Substance pour générer une nouvelle version des textures

## Sorties

Les options Sortie vous permettent d’activer ou de désactiver les sorties de Substance. Une sortie correspond à ce qui est généré par la Substance Engine et rendu en tant que texture dans l’arborescence du Shader.

...
helpx_learn_topic: ""
helpx_tags: ""
title: Moteur de changement d’ambiance
...
# Moteur de changement d’ambiance

## Substance Engine de commutation

Il existe deux versions de la Substance Engine : le processeur et le GPU. Le moteur GPU est utilisé pour créer des textures supérieures à 2K. Le moteur CPU n&#39;est capable de générer des textures que jusqu&#39;à 2K. Si vous avez besoin de textures de résolution plus élevées, vous devez passer au moteur GPU.
...
>[!NOTE]
>
> **L’utilisation du moteur GPU de Substance nécessite un GPU avec une RAM vidéo dédiée de 1 Go ou plus. Les GPU intégrés ne sont pas pris en charge.**\

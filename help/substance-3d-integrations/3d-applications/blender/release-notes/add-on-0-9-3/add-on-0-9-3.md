...
**Notes de mise à jour pour la version 0.9.3+** du module complémentaire

* Ajoutez des libellés d’espaces colorimétriques OCIO 2.0 dans les préférences du module complémentaire.
* Ajoutez des descriptions à la fabrique de paramètres/sorties sous forme d’info-bulles.
* Ajout d’une fonctionnalité de création de rapports (dans l’ensemble) (suppression des pop-ups invasifs et remplacement par des messages blender natifs).
* Mettez à jour le libellé de version SRE lors de l’installation et de la mise à jour dans les préférences du module complémentaire.
* Correction de la taille de sortie et du générateur aléatoire qui ne sont pas toujours disponibles dans une substance.
...
* Afficher la liste des versions prises en charge au lieu de la première lorsque SRE est manquant.

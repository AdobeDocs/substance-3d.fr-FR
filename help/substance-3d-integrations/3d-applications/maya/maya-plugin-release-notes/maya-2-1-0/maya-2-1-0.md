...
* Le plug-in substanceLink permet au lanceur d’envoyer des matériaux de Substance Source à l’intégration Maya lorsque l’interface utilisateur est ajoutée
...
* Sous Windows, Internet explorateur n’est plus ouvert
* Ajout d’un nouveau lien à la Substance share dans l’étagère et le menu

---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-integrations/game-engines/unity/unity-release-notes/unity-2-6-0.html"
breadcrumb-title: ''
...
* Dans les projets HDRP, le mode Displacement revient à la valeur par défaut (Pixellisation) lorsqu’une modification est apportée au paramètre Matériau
...
* L’erreur Accès refusé et/ou le blocage se produit lors de la mise à jour du plug-in à partir des versions antérieures 2.5.4 et antérieures
...
* Les aperçus de texture pour les fichiers image ne s’affichent pas dans l’inspecteur lorsque le module externe Substance est installé

...
* Les propriétés de matériau sont reportées sur l&#39;importation de paquets contenant des données de Substance
  * Remarque : cela s’applique uniquement aux packs créés à l’aide de la mise à jour 2.3.0 ou ultérieure
* Bouton Texture Baker ajouté au menu graphe Substance

### Correctifs de bogues :

* Correction d’un problème en raison duquel la répétition de matériau de Substance était réinitialisée si le dossier Bibliothèque était supprimé.
...
* Amélioration de la vitesse à la sortie du mode Lecture
* Correction d’un bug qui réinitialisait les propriétés du matériau de Substance lorsque le dossier Bibliothèque était supprimé

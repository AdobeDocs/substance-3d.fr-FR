---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-integrations/game-engines/unreal-engine/unreal-engine-4/blueprints-ue4/blueprintue4-node-reference.html"
breadcrumb-title: ''
...
| **EnableInstanceOutcomes** | Entrée : **SubstanceGraphInstance** - instance de graphe contenant la sortie pour activer l&#39;entrée : **OutputIndices** (tableau int32) - Index des sorties que vous souhaitez activer. (Sous réserve de modification) | Si cette option est désactivée précédemment, crée la ou les sorties de texture de données de transmises dans **SubstanceGraphInstance**. Cela a la même fonctionnalité que l&#39;activation d&#39;une sortie de l&#39;éditeur **SubstanceGraphInstance**. *REMARQUE : votre matériau ne sera pas mis à jour avec la nouvelle texture. Cela doit être géré en définissant un paramètre d&#39;échantillonnage au moment de l&#39;exécution à l&#39;aide de la nouvelle sortie.* |

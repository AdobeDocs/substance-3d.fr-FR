...
breadcrumb-title: ''
description: Guide de référence pour tous les nœuds Substance Blueprint disponibles dans Unreal Engine 4 pour les opérations sur les matériaux.
...
| --- | --- | --- |
| **GetSubstances** | Matériau | Renvoie un tableau d&#39;instances de Graphe Substance utilisées par un matériau. Si vous créez un matériau qui utilise des textures issues de deux instances de graphe différentes, cette fonction renvoie ces deux instances de graphe. |
...
| **GetGraphName** | **SubstanceGraphInstance** | Renvoie le nom du graphique tel qu’il est défini dans Designer. |
...
| **DisableInstanceOutcomes** | Entrée : **SubstanceGraphInstance** : instance de graphique à laquelle vous souhaitez appliquer des valeurs.Entrée : **SubstanceGraphInstance** : instance de graphique à partir de laquelle vous souhaitez obtenir les valeurs. | Restaure toutes les valeurs d&#39;entrée modifiées du paramètre d&#39;entrée Instance de Graphe Substance. |

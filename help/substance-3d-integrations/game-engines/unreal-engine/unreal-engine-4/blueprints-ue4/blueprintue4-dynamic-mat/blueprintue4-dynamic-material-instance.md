---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-integrations/game-engines/unreal-engine/unreal-engine-4/blueprints-ue4/blueprintue4-dynamic-material-instance.html"
breadcrumb-title: ''
...
1. Ajoutez un nœud For Loop. Ici, vous parcourez les textures de Substance. Utilisez le résultat de l’option Obtenir les textures de Substance comme tableau d’entrée.
...
1. Définissez la variable Nom MID sur les noms de canaux dans la matière de Substance dupliquée de l’étape 5. *Voir l’image du matériau.*
1. Dans le nœud Séquence Then 1, vous allez configurer le processus d&#39;affectation des noms de canaux au matériau dynamique.

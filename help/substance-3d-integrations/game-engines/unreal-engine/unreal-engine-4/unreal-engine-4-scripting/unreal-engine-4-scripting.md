...
breadcrumb-title: ''
description: Utilisez l’API de script Substance Unreal Engine 4 pour gérer par programme les matériaux de Substance dans vos projets.
helpx_creative_field: ""
helpx_description: Ecosystems and Plugins > Game Engines > Unreal Engine > Unreal Engine 4 > Unreal Engine 4 Scripting
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Scripts Unreal Engine 4
...
* **Installation du moteur** : [emplacement UE\_4.X.X]\Engine\Plugins\Marketplace\Substance\Source\SubstanceCore\Classes\SubstanceGraphInstance.h
...
L’éditeur Python dans Unreal Engine est accessible via Fenêtre > Outils de développement > Journal de sortie et en définissant le menu déroulant inférieur gauche sur Python.
